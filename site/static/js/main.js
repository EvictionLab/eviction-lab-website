 ...
 */
function createMediaTable(rows) {
 ...
 */
$(document).ready(function () {
  var SHEET_URL = 'https://spreadsheets.google.com/feeds/list/1fIHfkpG134ax5neHQGfipUrWbzPd-EAlVVlYqm4i9iE/2/public/values?alt=json';
  if ($("#national-media-table").length) {
    $.getJSON(SHEET_URL, function (data) {
      ...
      createMediaTable(rows.map(function (r) {
        var row = {};
