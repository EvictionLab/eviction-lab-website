...
collection: true
title: Tacoma, Washington | Eviction Tracking System
fbImage: /images/assets/graphics/ets-bg-social.png
---
{{< report_intro site_id="53053"  >}}
{{</ report_intro >}}


{{% trends_chart id="trends" data="/uploads/tacoma_barchart.csv" %}}

# Trends in eviction filings

This plot shows monthly eviction filings in Pierce County (Tacoma) over the past 12 months. Filings are displayed relative to average filings for the same set of months across 2023 and 2024 (the "baseline"). You can toggle the plot to display filing counts.<sup>1</sup>

1. Data for XXX are provided by the [XXX](https://www.nmcourts.gov/). 
...
{{% report_top_evictors id="topEvictorsSection" data="/uploads/tacoma_hotspots_media_report.csv" %}}
...
{{% report_chart id="race" data="/uploads/tacoma_linechart.csv" imputedNoteNumber="2" %}}
