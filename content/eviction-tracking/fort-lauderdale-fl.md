...
<style>
  .button-group.time-span .toggle:last-child::after {
    content: "²";
    position: relative;
    top: -3px;
  }
</style>
{{% trends_chart id="trends" data="/uploads/fortlauderdale_barchart.csv" %}}
...
2. Data not available for April, May, or June of 2022.
