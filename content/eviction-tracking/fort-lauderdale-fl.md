...
{{% report_chart id="avg" data="/uploads/fortlauderdale_barchart.csv" %}}
...
This plot shows monthly eviction filings in Fort Lauderdale over the past 12 months. Filings are displayed relative to average filings for the same set of months across 2023 and 2024 (the "baseline"). You can toggle the plot to display filing counts.<sup>1</sup>
...
{{% report_map shapes="/uploads/fortlauderdale_shapes.json" data="/uploads/fortlauderdale_map.csv" %}}
...
Broward County is divided into 417 census tracts. In each of those tracts, we map the number of eviction filings over the past 12 months. If you toggle below you can see these numbers as eviction filing rates—the number of eviction filings divided by the number of renter households in the area—or compared to the typical number of filings in the average year.<sup>1</sup> <sup>2</sup> <sup>3</sup>
...
{{% report_chart id="race" data="/uploads/fortlauderdale_linechart.csv" imputedNoteNumber="2" %}}
...
When you toggle the figure to see data relative to average, comparisons are being drawn—within the same set of neighborhoods defined by racial/ethnic majority—between filings over the past 12 months and average filings in 2014–2019.<sup>1</sup> <sup>2</sup>
