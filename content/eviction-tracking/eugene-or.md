...
collection: true
title: Eugene, Oregon | Eviction Tracking System
fbImage: /images/assets/graphics/ets-bg-social.png
---
{{< report_intro site_id="41039" >}}
{{</ report_intro >}}


{{% trends_chart id="trends" data="/uploads/eugene_barchart.csv" %}}

# Trends in eviction filings

This plot shows monthly eviction filings in Lane County (Eugene) over the past 12 months. Filings are displayed relative to average filings for the same set of months across 2023 and 2024 (the "baseline"). You can toggle the plot to display filing counts.<sup>1</sup>
...
{{% report_top_evictors id="topEvictorsSection" data="/uploads/eugene_hotspots_media_report.csv" %}}
...
{{% report_chart id="race" data="/uploads/eugene_linechart.csv" imputedNoteNumber="2" %}}
