...
---
{{< report_intro site_id="45019" area_site="true" >}}
...
This plot shows monthly eviction filings in Charleston over the past 12 months. Filings are displayed relative to average filings for the same set of months across 2023 and 2024 (the "baseline"). You can toggle the plot to display filing counts.<sup>1</sup>
