...
{{% report_map shapes="/uploads/nashville_shapes.json" data="/uploads/nashville_map.csv" %}}
...
{{% report_chart id="race" data="/uploads/nashville_linechart.csv" imputedNoteNumber="2" %}}
