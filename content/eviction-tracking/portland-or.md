...
rentersSite: Portland
areaSite: true
twImage: /images/assets/graphics/ets-bg-social.png
collection: true
title: Portland, Oregon | Eviction Tracking System
fbImage: /images/assets/graphics/ets-bg-social.png
---
{{< report_intro site_id="41051"  >}}
{{</ report_intro >}}


{{% trends_chart id="trends" data="/uploads/portland_barchart.csv" %}}

# Trends in eviction filings

This plot shows monthly eviction filings in Portland over the past 12 months. Filings are displayed relative to average filings for the same set of months across 2023 and 2024 (the "baseline"). You can toggle the plot to display filing counts.<sup>1</sup>

1. Data for Multnomah, Columbia, Washington, and Yamhill Counties are provided by the [XXX](https://www.nmcourts.gov/).  
...
{{% report_top_evictors id="topEvictorsSection" data="/uploads/portland_hotspots_media_report.csv" %}}
...
{{% report_map shapes="/uploads/portland_shapes.json" data="/uploads/portland_map.csv" topFilers="/uploads/portland_hotspots_media_report.csv" %}}

# The geography of eviction filings

Multnomah, Columbia, Washington, and Yamhill Counties are divided into XXX census tracts. In each of those tracts, we map the number of eviction filings over the past 12 months. If you toggle below you can see these numbers as eviction filing rates—the number of eviction filings divided by the number of renter households in the area—or compared to the typical number of filings in 2023–2024 (the "baseline").<sup>1</sup> <sup>2</sup>

1. Eviction filing data for Multnomah, Columbia, Washington, and Yamhill Counties are provided by the [XXX](https://www.nmcourts.gov/). 
...
{{% report_chart id="race" data="/uploads/portland_linechart.csv" imputedNoteNumber="2" %}}
