...
title: "In the most expensive city in the country, evictions remain lower than before COVID-19"
date: 2025-01-14T16:46:40.089Z
...
<iframe class="visual" src="https://development--eviction-lab-site.netlify.app/blog/nyc-evictions-stacked/"></iframe>
...
Another policy, implemented in 2019, gave tenants new tools to fight displacement and likely contributed to the lower eviction levels. The {{< smartlink "Housing Stability & Tenant Protection Act" "https://hcr.ny.gov/system/files/documents/2021/08/rent-laws-overview-english-10-2019.pdf" >}} (HSTPA) restricted rent increases, limited the capacity of landlords to strip units of existing rent restrictions, strengthened protections against retaliatory evictions, and limited conversions into condominiums, among other measures. 
...
<iframe class="visual" src="https://development--eviction-lab-site.netlify.app/blog/nyc-evictions/"></iframe>
<div class="legend mb-3">
  <div class="legend-item legend-item--0">
  <div class="legend-item__color"></div>
  <div class="legend-item__label">Bronx</div>
...
Some of the solutions have already been laid out: {{< smartlink "rental assistance during the pandemic was extremely effective" "https://evictionlab.org/covid-era-policies-cut-eviction-filings-by-more-than-half/" >}} and New York City renters currently have the option of applying to the {{< smartlink "“One shot deal” program" "https://access.nyc.gov/programs/one-shot-deal/" >}}, which has been providing short-term emergency financial aid for more than a decade.

But the needs in New York can be overwhelming: not only is it home to more renters than any other American city, but it is also one of the most unaffordable markets in the country. The local government just approved the  {{< smartlink "“City of Yes”" "https://gothamist.com/news/mayor-adams-5-billion-housing-plan-to-reshape-nyc-approved-by-city-council" >}} policy, which aims to increase the supply of housing, but the effects of this might take many years to be seen.
