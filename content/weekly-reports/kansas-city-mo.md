...
{{% report_chart id="avg" data="/uploads/kansas_barchart.csv" %}}
...
{{% report_map shapes="/uploads/kansas_shapes.json" data="/uploads/kansas_map.csv" %}}
...
{{% report_chart id="race" data="/uploads/kansas_linechart.csv" %}}
